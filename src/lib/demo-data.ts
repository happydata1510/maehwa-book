...
// 모든 데모 계정 목록 (mutable - 회원가입 시 추가됨)
export const DEMO_ACCOUNTS: { email: string; password: string; user: User; label: string; parent2Name?: string }[] = [
  ...
  { email: DEMO_PARENT.email, password: DEMO_PARENT_PASSWORD, user: DEMO_PARENT, label: "학부모 (김진환)", parent2Name: "전하라" },
];
